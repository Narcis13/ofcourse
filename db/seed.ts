  ...
  try {
    ...
    const courseData = [
      // Programming courses
      {
        ...
        description: "Build modern full-stack applications with Next.js 15, React 19, and TypeScript. Learn app router, server components, and deployment strategies.",
      ...
      },
      {
        ...
        description: "Create beautiful mobile applications using React Native. From setup to App Store deployment.",
        categoryId: insertedCategories.find(c => c.slug === "programming")!.id,
      ...
      },
      {
        ...
        description: "Build scalable design systems in Figma. Learn components, auto-layout, and team collaboration.",
        categoryId: insertedCategories.find(c => c.slug === "design")!.id,
      ...
      // Business courses
      {
        ...
        description: "Learn SEO, social media marketing, content strategy, and paid advertising to grow any business.",
      ...
      // Personal Development courses
      {
        ...
        description: "Transform your productivity with proven techniques, tools, and mindset shifts.",
        categoryId: insertedCategories.find(c => c.slug === "personal-development")!.id,
    ...
    const moduleData = [
          ...
          questions: [
            {
              ...
              options: ["Server Components", "Better routing", "Faster builds", "All of the above"],
              correctAnswer: 3
            }
          ]
        }
      },
      {
        ...
        interactiveConfig: {
          instructions: "Create a server component that fetches data from an API",
